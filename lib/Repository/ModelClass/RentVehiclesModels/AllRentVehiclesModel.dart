...
class AllRentVehiclesModel {
  ...
  AllRentVehiclesModel({this.location, this.id, this.brand, this.model, this.description, this.rentPrice, this.mileage, this.photos, this.vehicleColor, this.gearType, this.fuelType, this.noOfSeats, this.rating, this.noOfDoors, this.ownerName, this.ownerPhoneNumber, this.ownerPlace, this.ownerProfilePhoto, this.available, this.v});

  AllRentVehiclesModel.fromJson(Map<String, dynamic> json) {
  ...
  static List<AllRentVehiclesModel> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => AllRentVehiclesModel.fromJson(map)).toList();
  }
  ...
  static List<AllRentVehiclesModel> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => AllRentVehiclesModel.fromJson(value)).toList();
  }
  AllRentVehiclesModel copyWith({
    Location? location,
    String? id,
    String? brand,
    String? model,
