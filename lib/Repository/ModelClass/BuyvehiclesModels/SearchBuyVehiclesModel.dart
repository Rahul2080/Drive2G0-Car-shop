class SearchBuyVehiclesModel {
  SearchBuyVehiclesModel({
      this.location, 
      this.id, 
      this.brand, 
      this.model, 
  ...
  SearchBuyVehiclesModel.fromJson(dynamic json) {
  ...
  static List<SearchBuyVehiclesModel> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => SearchBuyVehiclesModel.fromJson(value)).toList();
  }
}
