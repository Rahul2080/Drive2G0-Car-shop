...
class BuyNearVehiclesModel {
  ...
  static List<BuyNearVehiclesModel> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => BuyNearVehiclesModel.fromJson(map)).toList();
  }
  ...
  static List<BuyNearVehiclesModel> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => BuyNearVehiclesModel.fromJson(value)).toList();
  }
  BuyNearVehiclesModel copyWith({
    Location? location,
    String? id,
    String? brand,
    String? model,
