...
class BuyAllVehiclesModel {
  ...
  BuyAllVehiclesModel({this.location, this.id, this.brand, this.model, this.description, this.rentPrice, this.mileage, this.photos, this.vehicleColor, this.gearType, this.fuelType, this.noOfSeats, this.rating, this.noOfDoors, this.ownerName, this.ownerPhoneNumber, this.ownerPlace, this.ownerProfilePhoto, this.available, this.latestModel, this.highMilage, this.v});

  BuyAllVehiclesModel.fromJson(Map<String, dynamic> json) {
  ...
  static List<BuyAllVehiclesModel> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => BuyAllVehiclesModel.fromJson(map)).toList();
  }
  ...
  static List<BuyAllVehiclesModel> listFromJson(List<dynamic> json) {
    return json == null
        ? []
        : json.map((value) => BuyAllVehiclesModel.fromJson(value)).toList();
  }
  BuyAllVehiclesModel copyWith({
    Location? location,
    String? id,
    String? brand,
    String? model,
