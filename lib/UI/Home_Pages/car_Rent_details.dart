...
class _CarRentDetailsState extends State<CarRentDetails> {
  ...
  void initState() {
    _getCurrentLocation();
    BlocProvider.of<GetAllRentVehiclesByIdBloc>(context)
        .add(FeatchGetAllRentVehiclesById(vehicleId: widget.vehicleid));
    super.initState();
  }
...
//Url Launcher
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Colors.black,
      body:
          BlocBuilder<GetAllRentVehiclesByIdBloc, GetAllRentVehiclesByIdState>(
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      getallrentvehiclesbyid.ownerProfilePhoto
                                          .toString(),
                                      fit: BoxFit.cover,
                                    )),
                              ),
                              ...
                              InkWell(
                                onTap: () => launchURL(
                                    Uri.parse(
                                        'https://wa.me/+91 ${getallrentvehiclesbyid.ownerPhoneNumber}'),
                                    false),
                                child: Image.asset(
                                  'assets/whatsapp.png',
                                  width: 30.w,
                              ...
                              InkWell(
                                onTap: () => launchURL(
                                    Uri.parse(
                                        'tel:${getallrentvehiclesbyid.ownerPhoneNumber}'),
                                    false),
                                child: Icon(
